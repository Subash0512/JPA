...
public class NotificationService {
    ...
    public void sendBillingNotification(String patientEmail, String billingDetails) {
        try {
            ...
            mailSender.send(message);
            System.out.println("Billing notification email sent to: " + patientEmail);
        } catch (Exception e) {
            System.err.println("Failed to send billing email to " + patientEmail + ": " + e.getMessage());
            throw new RuntimeException("Email sending failed", e);
        }
    }
    ...
    public void sendMedicalRecordNotification(String patientEmail, String recordDetails) {
        try {
            ...
            mailSender.send(message);
            System.out.println("Medical record notification email sent to: " + patientEmail);
        } catch (Exception e) {
            System.err.println("Failed to send medical record email to " + patientEmail + ": " + e.getMessage());
            throw new RuntimeException("Email sending failed", e);
        }
